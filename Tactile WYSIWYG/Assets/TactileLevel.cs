...
public class TactileLevel : MonoBehaviour {
    ...
    private void createDeco(List<LibraryObject> library, XmlNode xmlNode, int i, int j)
    {
        ...
        deco.x = i;
        deco.y = j;
        deco.dir = XmlUtil.Get(xmlNode, "dir", 0);
        deco.objectName = id;
    ...
    public void Save()
    {
        ...
        foreach(TactileDeco deco in decos)
        {
            ...
            nodeDeco.Attributes.Append(createAttribute(doc, "dir", deco.dir.ToString()));
        ...
        foreach (TactileDoor door in doors)
        {
            ...
            nodeDoor.Attributes.Append(createAttribute(doc, "dir", door.dir.ToString()));
